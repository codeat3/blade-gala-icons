...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('galaicon-add')->toHtml();
    ...
    {
        $result = svg('galaicon-add', 'w-6 h-6 text-gray-500')->toHtml();
        $expected = <<<'SVG'
    ...
    {
        $result = svg('galaicon-add', ['style' => 'color: #555'])->toHtml();
    ...
    public function it_can_merge_default_class_from_config()
    {
        ...
        $result = svg('galaicon-add', 'w-6 h-6')->toHtml();
